package WWW::Salesforce::ChildRelationship;
use 5.008001;
...
has 'cascadeDelete' => ( is => 'rw', isa => 'Bool', default => 0, );
has 'childSObject' => ( is => 'rw', isa => 'Str', default => '' );
...
WWW::Salesforce::ChildRelationship - TODO (-- Add documentation)

=head1 DESCRIPTION

WWW::Salesforce::ChildRelationship is a subclass of L<WWW::Salesforce::SObject|WWW::Salesforce::SObject>. This is one of the complex types Salesforce returns from a method call.
...
X<new>
Creates a new WWW::Salesforce::ChildRelationship object.  You shouldn't ever have to create this object on your own.

 my $ChildRelationship = WWW::Salesforce::ChildRelationship->new();
...
L<http://www.salesforce.com/us/developer/docs/api/Content/sforce_api_calls_convertlead_ChildRelationship.htm>
